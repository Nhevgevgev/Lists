...
namespace Lists.Tests
{
    public class LinkedListTests
    {
        ...
        public void AddLinkedList_WhenValidValuePassed_ShouldAddLinkedListInTheEndOfTheOtherList_Tests(int[] actualArray, int[] expectedArray)
        {
            LinkedList actual = LinkedList.Create(actualArray);
            LinkedList expected = LinkedList.Create(expectedArray);
            LinkedList addedList = LinkedList.Create(new int[] { 0, 0, 0 });
        ...
        public void AddLinkedListToStart_WhenValidValuePassed_ShouldAddLinkedListInTheEndOfTheOtherList_Tests(int[] actualArray, int[] expectedArray)
        {
            LinkedList actual = LinkedList.Create(actualArray);
            LinkedList expected = LinkedList.Create(expectedArray);
            LinkedList addedList = LinkedList.Create(new int[] { 0, 0, 0 });
        ...
        public void AddLinkedListByIndex_WhenValidValuePassed_ShouldAddLinkedListByIndexToOtherList_Tests(
            int index, int[] actualArray, int[] expectedArray)
        {
            LinkedList actual = LinkedList.Create(actualArray);
            LinkedList expected = LinkedList.Create(expectedArray);
        ...
        public void AddLinkedListByIndex_WhenInvalidValuePassed_ShouldReturnIndexOutOfRangeException_NegativeTests(
            LinkedList list, int index, int[] actualArray)
        {
            LinkedList actual = LinkedList.Create(actualArray);
